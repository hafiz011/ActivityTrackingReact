...
const features = [
  ...
  },
  {
    ...
    desc: "See not just what happened, but why. Tracly reveals the story behind every user journey.",
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-8 text-gray-200 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
              <p className="bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent">
                <strong className="text-cyan-300 font-bold text-2xl">Tracly doesn't just show you what users do — we tell you what to do next.</strong>
              </p>
              ...
              <p className="text-gray-300 leading-relaxed">
                Tracly bridges the gap with real-time session tracking, 
